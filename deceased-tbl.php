      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="graveplot-tbl.php">
            <i class="material-symbols-rounded opacity-5">table_view</i>
            <span class="nav-link-text ms-1">Grave and Plot Records</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    if (isset($_GET['status'])) {
      ...
      if (isset($_GET['status'])) {
        ...
        if ($status == 'added') {
          ...
          echo "<div id='notification' class='alert alert-danger'>There was an error processing your request.</div>";
        }
      }
    }
    ?>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                <h6 class="text-white text-capitalize ps-3">Deceased Records</h6>
                <button class="btn newbtm" style="background-color: #3e6553; color: white; margin-right: 1rem;" data-bs-toggle="modal" data-bs-target="#addDeceasedModal">
                  Add Record
                </button>
              </div>
            </div>
